package com.sviatenterprise.contoller;

import com.sviatenterprise.service.UpdateProducer;
import com.sviatenterprise.utils.MessageUtils;
...
public class UpdateController {
    ...
    private void setUnsupportedMessageTypeView(Update update) {
        var sendMessage = messageUtils.generateSendMessageWithText(update,
                "Тип повідомлення не підтримується");
        setView(sendMessage);
    }

    private void setFileIsReceivedView(Update update) {
        var sendMessage = messageUtils.generateSendMessageWithText(update,
                "Файл отримано. Триває обробка...");
        setView(sendMessage);
    }
